...
const TheatreScreen = () => {
  ...
  const subscribe = async () => {
    /*
   HERE WE WILL MAKE REQUEST TO BACK-END FOR PROCESSING THE PAYMENT 
   NOT IMPLEMENTED FOR NOW DIRECTLY PAYMENT IS ASSUMED TO BE SUCCESSFULLY
   DONE
   AND USER IS TAKEN TO TICKET BOOKED PAGE 
   */
    occupied.push(...seats);
